...
const transformIndexToState = (rowIndex, colIndex, grid) => withinIndex(rowIndex, colIndex, grid) ? grid[rowIndex][colIndex] : 0;

const withinIndex = (rowIndex, colIndex, grid) => rowIndex >= 0 && rowIndex < grid.length && colIndex >= 0 && colIndex < grid[rowIndex].length;
